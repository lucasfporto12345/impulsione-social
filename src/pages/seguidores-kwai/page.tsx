...
const packages = [
  {
    ...
    popular: false,
    yampiLink: 'https://pay.impulsionesocial.com/imp-kwai-500-seguidores-brasileiros'
  },
  {
    quantity: '1000',
    type: 'Brasileiros',
    ...
    features: ['Não precisa de senha', 'Entrega imediata', 'E-book Kwai Prime'],
    popular: true,
    yampiLink: 'https://pay.impulsionesocial.com/imp-kwai-1000-seguidores-brasileiros'
  },
  {
    quantity: '2000',
    type: 'Brasileiros',
    ...
    features: ['Não precisa de senha', 'Entrega imediata', 'E-book Kwai Prime'],
    popular: false,
    yampiLink: 'https://pay.impulsionesocial.com/imp-kwai-2000-seguidores-brasileiros'
  },
  {
    quantity: '3000',
    type: 'Brasileiros',
    ...
    features: ['Não precisa de senha', 'Entrega imediata', 'E-book Kwai Prime'],
    popular: false,
    yampiLink: 'https://pay.impulsionesocial.com/imp-kwai-3000-seguidores-brasileiros'
  },
  {
    quantity: '5000',
    type: 'Brasileiros',
    ...
    features: ['Não precisa de senha', 'Entrega imediata', 'E-book Kwai Prime'],
    popular: false,
    yampiLink: 'https://pay.impulsionesocial.com/imp-kwai-5000-seguidores-brasileiros'
  },
  {
    quantity: '10000',
    type: 'Brasileiros',
    ...
    popular: false,
    bestValue: true,
    yampiLink: 'https://pay.impulsionesocial.com/imp-kwai-10000-seguidores-brasileiros'
  }
];
...
const steps = [
  ...
  },
  {
    ...
    description: 'Insira o link do seu perfil do Kwai'
  },
  {
...
const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    text: 'Aumentei minha credibilidade no Kwai e agora tenho muito mais engajamento.'
  },
  {
...
const faqs = [
  {
    ...
    answer: 'Você receberá todos seguidores do seu pacote em até 24 horas. Solicitamos esse prazo para garantir que todos os seus seguidores serão entregues, porém normalmente o recebimento dos seguidores é de 1 – 4 horas no Kwai.'
  },
  {
  ...
  {
    question: 'Quantos seguidores no Kwai posso comprar?',
...
export default function SeguidoresKwai() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-8">
              <a href="/" className="flex items-center">
                <span className="text-2xl font-bold text-gray-900">
                  <span className="text-orange-500">Impulsione</span> Social
                </span>
              </a>
            ...
            <div className="hidden md:block">
              <a href="#pacotes" className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-2 rounded-full font-medium hover:from-orange-600 hover:to-orange-700 transition-all whitespace-nowrap cursor-pointer">
                Ver Pacotes
              </a>
            </div>
            <button 
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-4 bg-gradient-to-br from-orange-50 via-yellow-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div
                ...
                className={`relative bg-white rounded-2xl p-6 transition-all hover:shadow-xl hover:scale-105 ${
                  pkg.popular
                    ...
                    : 'border-2 border-gray-300 hover:border-orange-400 shadow-md'
                }`}
              >
                {pkg.popular && (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Como comprar seguidores para Kwai
            </h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
              Nosso processo é muito básico e fácil, criamos o site Impulsione Social de uma forma simples e intuitiva para todos. <strong>Com 3 cliques simples</strong> você pode comprar o pacote de seguidores que quiser para o Kwai.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Por que comprar seguidores no Kwai?
              </h2>
              <p className="text-gray-600 mb-6">
                No mundo competitivo das mídias sociais, o Kwai se tornou uma plataforma essencial para indivíduos, empresas e marcas que buscam se destacar e aumentar sua presença digital. A decisão de comprar seguidores do Kwai pode ser um passo estratégico para impulsionar sua visibilidade e alcance nesta rede social.
              </p>
              <h3 className="text-xl font-bold text-gray-900 mb-4">
                Por que é importante ter seguidores no Kwai?
              </h3>
              <p className="text-gray-600 mb-6">
                Na era digital de hoje, a contagem de seguidores do Kwai se tornou um indicador crucial de credibilidade e sucesso. Uma conta com uma base sólida de seguidores cria maior confiança e naturalmente atrai mais atenção. Para empresas e criadores de conteúdo, isso se traduz em melhores oportunidades de negócios e colaborações.
              </p>
              <p className="text-gray-600 mb-6">
              ...
              <a 
                href="#pacotes" 
                className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 rounded-full font-medium hover:from-orange-600 hover:to-orange-700 transition-all whitespace-nowrap cursor-pointer"
              >
                Comprar agora
              </a>
            </div>
            <div className="relative">
              <div className="w-full h-96 rounded-3xl overflow-hidden">
                <img 
                  src="https://readdy.ai/api/search-image?query=Modern%20smartphone%20displaying%20Kwai%20app%20interface%20with%20follower%20count%20increasing%2C%20social%20media%20growth%20concept%2C%20clean%20minimalist%20design%2C%20bright%20orange%20and%20yellow%20colors%2C%20professional%20marketing%20photography%2C%20high%20quality%20digital%20illustration&width=600&height=800&seq=kwai-growth&orientation=portrait" 
                  alt="Kwai Growth" 
            ...
            <div className="inline-flex items-center gap-8 bg-white rounded-2xl p-6 shadow-lg">
              ...
              <div className="text-left">
                ...
                <p className="text-gray-600">
                  Como uma equipe em crescimento nas redes e após anos de estudo, aprendemos esses aspectos para comprar seguidores no Kwai
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            <a 
              href="#pacotes" 
              className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white px-8 py-4 rounded-full font-medium text-lg hover:from-orange-600 hover:to-orange-700 transition-all shadow-lg whitespace-nowrap cursor-pointer"
            >
      ...
      <section className="py-16 bg-gradient-to-r from-orange-500 to-orange-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Impulsione Social – Seu provedor nº 1 do Kwai
          </h2>
          ...
          <a 
            href="/#services" 
            className="inline-flex items-center gap-2 bg-white text-orange-600 px-8 py-4 rounded-full font-medium text-lg hover:bg-gray-50 transition-all shadow-lg whitespace-nowrap cursor-pointer"
          >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.instagram.com/impulsionesocialoficial" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-orange-100 transition-colors cursor-pointer">
