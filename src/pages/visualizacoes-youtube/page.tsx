...
export default function VisualizacoesYoutubePage() {
  ...
  const packages = [
    {
      quantity: '500',
      price: 'R$14,90',
      link: 'https://pay.impulsionesocial.com/imp-youtube-500-visualizacoes-no-youtube'
    },
    {
      quantity: '1.000',
      price: 'R$27,90',
      link: 'https://pay.impulsionesocial.com/imp-youtube-1000-visualizacoes-no-youtube'
    },
    {
      quantity: '2.000',
      price: 'R$54,90',
      link: 'https://pay.impulsionesocial.com/imp-youtube-2000-visualizacoes-no-youtube'
    },
    {
      quantity: '3.000',
      price: 'R$74,90',
      link: 'https://pay.impulsionesocial.com/imp-youtube-3000-visualizacoes-no-youtube'
    },
    {
      quantity: '5.000',
      price: 'R$114,90',
      link: 'https://pay.impulsionesocial.com/imp-youtube-5000-visualizacoes-no-youtube'
    },
    {
      quantity: '10.000',
      price: 'R$219,90',
      link: 'https://pay.impulsionesocial.com/imp-youtube-10000-visualizacoes-no-youtube'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-red-50">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-red-600 via-red-500 to-red-600 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Visualizações no Youtube</h1>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {packages.map((pkg, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 border-2 border-red-100">
                <div className="text-center">
                  <h3 className="text-5xl font-bold text-red-600 mb-2">{pkg.quantity}</h3>
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 whitespace-nowrap cursor-pointer"
                  >
                    Comprar Agora
                  </button>
                </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-4 text-gray-800">Como comprar Visualizações para YouTube</h2>
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-red-50 to-orange-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-6 text-gray-800">Por que comprar visualizações no YouTube?</h2>
          ...
          <h3 className="text-2xl font-bold mb-4 text-gray-800">Por que é importante ter visualizações no YouTube?</h3>
          ...
          <p className="text-gray-700 mb-8 leading-relaxed">
            O YouTube não é apenas mais uma plataforma de mídia social; é uma ferramenta de marketing poderosa que pode impulsionar significativamente sua presença online. Com mais de 1 bilhão de usuários ativos, a plataforma oferece alcance inigualável para se conectar com seu público-alvo.
          </p>
          
          <div className="text-center">
            <a 
              href="#compra"
              className="inline-block bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 whitespace-nowrap cursor-pointer"
            >
              Comprar agora
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <div className="flex items-start mb-4">
                <div className="w-12 h-12 bg-gradient-to-r from-red-600 to-red-500 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
      ...
      {/* CTA Final */}
      <section className="py-16 px-4 bg-gradient-to-r from-red-600 via-red-500 to-red-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6">Cresça nas Redes com a N°1 do Brasil</h2>
          <p className="text-xl mb-8">
            Lembre-se de que também oferecemos outros serviços e que você pode <strong>comprar seguidores no YouTube e curtidas em minutos.</strong>
          </p>
          <a 
            href="#compra"
            className="inline-block bg-white text-red-600 hover:bg-gray-100 font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 whitespace-nowrap cursor-pointer"
          >
            Comprar agora
          </a>
        </div>
