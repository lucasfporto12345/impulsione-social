...
export default function CurtidasYoutubePage() {
  ...
  const packages = [
    {
      amount: '500',
      price: 'R$14,90',
      link: 'https://pay.impulsionesocial.com/imp-youtube-500-curtidas-no-video'
    },
    {
      amount: '1.000',
      price: 'R$24,90',
      link: 'https://pay.impulsionesocial.com/imp-youtube-1000-curtidas-no-video'
    },
    {
      amount: '2.000',
      price: 'R$44,90',
      link: 'https://pay.impulsionesocial.com/imp-youtube-2000-curtidas-no-video'
    },
    {
      amount: '3.000',
      price: 'R$64,90',
      link: 'https://pay.impulsionesocial.com/imp-youtube-3000-curtidas-no-video'
    },
    {
      amount: '5.000',
      price: 'R$99,90',
      link: 'https://pay.impulsionesocial.com/imp-youtube-5000-curtidas-no-video'
    },
    {
      amount: '10.000',
      price: 'R$189,90',
      link: 'https://pay.impulsionesocial.com/imp-youtube-10000-curtidas-no-video'
    }
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Não! Absolutamente não é necessário informar sua senha ou e-mail do seu perfil, somente o link do vídeo.'
    },
    {
      question: 'É seguro comprar curtidas no YouTube?',
    ...
    {
      question: 'Quantas curtidas no YouTube posso comprar?',
    ...
    {
      question: 'O YouTube impede marcas de comprar?',
      answer: 'O YouTube não remove curtidas ou impede marcas por receber muitas curtidas em pouco tempo.'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="/#servicos" className={`font-medium transition-colors whitespace-nowrap cursor-pointer ${scrolled ? 'text-gray-700 hover:text-red-600' : 'text-gray-800 hover:text-red-600'}`}>
                Serviços
              </a>
              <a href="/#sobre" className={`font-medium transition-colors whitespace-nowrap cursor-pointer ${scrolled ? 'text-gray-700 hover:text-red-600' : 'text-gray-800 hover:text-red-600'}`}>
                Sobre
              </a>
              <a href="/#contato" className={`font-medium transition-colors whitespace-nowrap cursor-pointer ${scrolled ? 'text-gray-700 hover:text-red-600' : 'text-gray-800 hover:text-red-600'}`}>
                Contato
              </a>
              <a href="#pacotes" className="bg-gradient-to-r from-red-600 to-red-700 text-white px-6 py-2.5 rounded-full font-semibold hover:shadow-lg transition-all whitespace-nowrap cursor-pointer">
                Comprar Agora
              </a>
            </div>
          </div>
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-16 px-4 bg-gradient-to-br from-red-50 via-white to-red-50">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Curtidas no Vídeo do YouTube
          </h1>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {packages.map((pkg, index) => (
              <div
                key={index}
                className="bg-gradient-to-br from-white to-red-50 rounded-2xl p-8 border-2 border-red-100 hover:border-red-300 hover:shadow-xl transition-all duration-300"
              >
                <div className="text-center mb-6">
                  <h3 className="text-5xl font-bold text-red-600 mb-2">{pkg.amount}</h3>
                ...
                <ul className="space-y-3 mb-8">
                  ...
                  <li className="flex items-center text-gray-700">
                    <i className="ri-check-line text-red-600 text-xl mr-3"></i>
                    <span>E-book YouTube Prime</span>
                  </li>
                </ul>

                <button
                  onClick={() => handleBuyClick(pkg.link)}
                  className="w-full bg-gradient-to-r from-red-600 to-red-700 text-white py-4 rounded-xl font-bold text-lg hover:shadow-lg hover:scale-105 transition-all whitespace-nowrap cursor-pointer"
                >
                  Comprar Agora
                </button>
              </div>
      ...
      {/* How to Buy Section */}
      <section className="py-20 px-4 bg-gradient-to-br from-red-50 via-white to-red-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Como comprar curtidas para YouTube
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all">
              ...
              <p className="text-gray-600 text-center">
                Insira o link do seu vídeo do YouTube após finalizar o pagamento.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <a
                href="#pacotes"
                className="inline-block mt-8 bg-gradient-to-r from-red-600 to-red-700 text-white px-8 py-4 rounded-full font-bold text-lg hover:shadow-lg hover:scale-105 transition-all whitespace-nowrap cursor-pointer"
              >
                Comprar agora
              </a>
            </div>
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-red-200 to-red-300 rounded-3xl transform rotate-3"></div>
              <div className="relative bg-gradient-to-br from-red-600 to-red-700 rounded-3xl p-12 text-white">
                <i className="ri-youtube-fill text-9xl opacity-20 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></i>
                <div className="relative z-10">
                  ...
                  <ul className="space-y-4">
                    ...
                    <li className="flex items-start">
                      <i className="ri-check-double-line text-2xl mr-3 mt-1"></i>
                      <span className="text-lg">Atração de novos espectadores</span>
                    </li>
                    <li className="flex items-start">
                      <i className="ri-check-double-line text-2xl mr-3 mt-1"></i>
                      <span className="text-lg">Melhor posicionamento nos resultados</span>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all">
              ...
              <p className="text-gray-600">
                Comprar curtidas fará com que seus próximos vídeos tenham mais interação e alcance.
              </p>
            </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-red-50 to-white rounded-2xl p-8 border-2 border-red-100">
              <h4 className="text-2xl font-bold text-gray-900 mb-4">
                Pode ter um impacto negativo sobre mim?
              </h4>
              <div className="w-16 h-1 bg-gradient-to-r from-red-600 to-red-700 mb-6"></div>
              <p className="text-gray-600 mb-4">
                Não, quando você faz uma compra com a Impulsione Social sua conta não corre nenhum perigo, e isso é legal. Não violamos nenhuma regra do YouTube ao realizar esse processo, por isso é 100% seguro.
              </p>
              <p className="text-gray-600">
                Milhares de grandes influenciadores do YouTube usam esses métodos. Se houvesse algum problema com isso, eles não ousariam expor suas contas a eles.
              </p>
            </div>
          ...
          <div className="text-center mt-12">
            <a
              href="#pacotes"
              className="inline-block bg-gradient-to-r from-red-600 to-red-700 text-white px-8 py-4 rounded-full font-bold text-lg hover:shadow-lg hover:scale-105 transition-all whitespace-nowrap cursor-pointer"
            >
              Comprar agora
            </a>
          </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-red-50 via-white to-red-50">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-6">
                <span className="text-red-600">4 razões para comprar curtidas</span> na Impulsione Social
              </h2>
              <p className="text-lg text-gray-600 mb-12">
                Como uma equipe em crescimento nas redes e após anos de estudo, aprendemos esses aspectos para comprar curtidas no YouTube:
              </p>

              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-12 h-12 bg-gradient-to-br from-red-600 to-red-700 rounded-xl flex items-center justify-center mr-4 flex-shrink-0">
            ...
            <div className="flex justify-center">
              <img 
                src="https://seguidoresprimer.com/wp-content/uploads/2025/06/pq-segui-youtube-1.png" 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { name: 'Resultados incríveis!', rating: 5, text: 'Aumentei minha credibilidade no YouTube e agora tenho muito mais engajamento.' },
              ...
              <div key={index} className="bg-gradient-to-br from-red-50 to-white rounded-2xl p-6 border-2 border-red-100 hover:shadow-lg transition-all">
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-red-50 via-white to-red-50">
        <div className="max-w-4xl mx-auto text-center">
          <a
            href="#pacotes"
            className="inline-block bg-gradient-to-r from-red-600 to-red-700 text-white px-12 py-5 rounded-full font-bold text-xl hover:shadow-2xl hover:scale-105 transition-all whitespace-nowrap cursor-pointer mb-12"
          >
            Comprar agora
          </a>
              ...
              {faqs.slice(0, 4).map((faq, index) => (
                <div key={index} className="bg-white rounded-xl border-2 border-gray-200 overflow-hidden">
                  <button
                    ...
                    className="w-full px-6 py-4 text-left flex items-center justify-between hover:bg-red-50 transition-colors cursor-pointer"
                  >
                    <span className="font-bold text-gray-900 pr-4">{faq.question}</span>
                    <i className={`ri-arrow-${openFaq === index ? 'up' : 'down'}-s-line text-2xl text-red-600 flex-shrink-0`}></i>
                  </button>
                  {openFaq === index && (
            ...
            <div className="space-y-4">
              {faqs.slice(4, 8).map((faq, index) => (
                <div key={index + 4} className="bg-white rounded-xl border-2 border-gray-200 overflow-hidden">
                  ...
                  >
                    <span className="font-bold text-gray-900 pr-4">{faq.question}</span>
                    <i className={`ri-arrow-${openFaq === (index + 4) ? 'up' : 'down'}-s-line text-2xl text-red-600 flex-shrink-0`}></i>
                  </button>
                  {openFaq === (index + 4) && (
                    <div className="px-6 pb-4">
                      <p className="text-gray-600">{faq.answer}</p>
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-br from-red-600 to-red-700 text-white py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-red-100">
                ...
                <li><a href="/curtidas-youtube" className="hover:text-white transition-colors cursor-pointer">Curtidas YouTube</a></li>
              </ul>
            </div>
            <div>
