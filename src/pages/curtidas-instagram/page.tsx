...
const mundialPackages = [
  {
    ...
    price: 'R$10,90',
    oldPrice: 'R$19,90',
    discount: 'DESCONTO DE R$10,00',
    features: ['Não precisa de senha', '30 Dias de reposição', 'Entrega rápida', 'E-book Instagram Prime'],
    popular: false,
    checkoutLink: 'https://pay.impulsionesocial.com/imp-instagram-500-curtidas-mundiais'
  },
  {
    quantity: '1000',
    type: 'Mundiais',
    ...
    features: ['Não precisa de senha', '30 Dias de reposição', 'Entrega rápida', 'E-book Instagram Prime'],
    popular: true,
    checkoutLink: 'https://pay.impulsionesocial.com/imp-instagram-1000-curtidas-mundiais'
  },
  {
    quantity: '2000',
    type: 'Mundiais',
    price: 'R$39,90',
    oldPrice: 'R$49,90',
    discount: 'DESCONTO DE R$25,00',
    features: ['Não precisa de senha', '30 Dias de reposição', 'Entrega rápida', 'E-book Instagram Prime'],
    popular: false,
    checkoutLink: 'https://pay.impulsionesocial.com/imp-instagram-2000-curtidas-mundiais'
  },
  {
    quantity: '3000',
    type: 'Mundiais',
    price: 'R$59,90',
    oldPrice: 'R$69,90',
    discount: 'DESCONTO DE R$35,00',
    features: ['Não precisa de senha', '30 Dias de reposição', 'Entrega rápida', 'E-book Instagram Prime'],
    popular: false,
    checkoutLink: 'https://pay.impulsionesocial.com/imp-instagram-3000-curtidas-mundiais'
  },
  {
    quantity: '5000',
    type: 'Mundiais',
    price: 'R$89,90',
    oldPrice: 'R$109,90',
    discount: 'DESCONTO DE R$55,00',
    features: ['Não precisa de senha', '30 Dias de reposição', 'Entrega rápida', 'E-book Instagram Prime'],
    popular: false,
    checkoutLink: 'https://pay.impulsionesocial.com/imp-instagram-5000-curtidas-mundiais'
  },
  {
    quantity: '10000',
    type: 'Mundiais',
    price: 'R$159,90',
    oldPrice: 'R$199,90',
    discount: 'DESCONTO DE R$100,00',
    features: ['Não precisa de senha', '30 Dias de reposição', 'Entrega rápida', 'E-book Instagram Prime'],
    popular: false,
    bestValue: true,
    checkoutLink: 'https://pay.impulsionesocial.com/imp-instagram-10000-curtidas-mundiais'
  }
];
...
const brasileirasPackages = [
  {
    ...
    features: ['Não precisa de senha', '30 Dias de reposição', 'Entrega rápida', 'E-book Instagram Prime'],
    popular: false,
    checkoutLink: 'https://pay.impulsionesocial.com/imp-instagram-500-curtidas-brasileiras'
  },
  {
    quantity: '1000',
    type: 'Brasileiras',
    ...
    features: ['Não precisa de senha', '30 Dias de reposição', 'Entrega rápida', 'E-book Instagram Prime'],
    popular: true,
    checkoutLink: 'https://pay.impulsionesocial.com/imp-instagram-1000-curtidas-brasileiras'
  },
  {
    quantity: '2000',
    type: 'Brasileiras',
    price: 'R$59,90',
    oldPrice: 'R$89,90',
    discount: 'DESCONTO DE R$45,00',
    features: ['Não precisa de senha', '30 Dias de reposição', 'Entrega rápida', 'E-book Instagram Prime'],
    popular: false,
    checkoutLink: 'https://pay.impulsionesocial.com/imp-instagram-2000-curtidas-brasileiras'
  },
  {
    quantity: '3000',
    type: 'Brasileiras',
    ...
    features: ['Não precisa de senha', '30 Dias de reposição', 'Entrega rápida', 'E-book Instagram Prime'],
    popular: false,
    checkoutLink: 'https://pay.impulsionesocial.com/imp-instagram-3000-curtidas-brasileiras'
  },
  {
    quantity: '5000',
    type: 'Brasileiras',
    ...
    features: ['Não precisa de senha', '30 Dias de reposição', 'Entrega rápida', 'E-book Instagram Prime'],
    popular: false,
    checkoutLink: 'https://pay.impulsionesocial.com/imp-instagram-5000-curtidas-brasileiras'
  },
  {
    quantity: '10000',
    type: 'Brasileiras',
    price: 'R$249,90',
    oldPrice: 'R$359,90',
    discount: 'DESCONTO DE R$180,00',
    features: ['Não precisa de senha', '30 Dias de reposição', 'Entrega rápida', 'E-book Instagram Prime'],
    popular: false,
    bestValue: true,
    checkoutLink: 'https://pay.impulsionesocial.com/imp-instagram-10000-curtidas-brasileiras'
  }
];
...
const benefits = [
  ...
  },
  {
    ...
    description: 'Comprar curtidas fará com que suas próximas postagens e histórias tenham mais interação e alcance.'
  },
  {
    icon: 'ri-money-dollar-circle-line',
    color: 'from-green-500 to-emerald-500',
    title: 'Economize dinheiro com seguidores baratos',
    description: 'Não se confunda, oferecer seguidores baratos não é sinônimo de qualidade, trabalhamos com o melhor sistema para entregar.'
  },
  {
...
export default function CurtidasInstagram() {
  ...
  useEffect(() => {
    const criticalImages = [
      'https://seguidoresprimer.com/wp-content/uploads/2025/06/ig-pq-prime-1.png'
    ];
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-8">
              <a href="/" className="flex items-center">
                <span className="text-2xl font-bold text-gray-900">
                  <span className="bg-gradient-to-r from-pink-500 to-purple-600 bg-clip-text text-transparent">Impulsione</span> Social
                </span>
              </a>
            ...
            <div className="hidden md:block">
              <a href="#pacotes" className="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-6 py-2 rounded-full font-medium hover:from-pink-600 hover:to-purple-700 transition-all whitespace-nowrap cursor-pointer">
                Ver Pacotes
              </a>
            </div>
            <button 
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-4 bg-gradient-to-br from-pink-50 via-purple-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center py-6">
            <div className="inline-flex items-center gap-2 bg-white border border-pink-200 px-4 py-2 rounded-full text-sm font-medium mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Como comprar curtidas para instagram
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <a 
                href="#pacotes" 
                className="inline-flex items-center gap-2 bg-gradient-to-r from-pink-500 to-purple-600 text-white px-6 py-3 rounded-full font-medium hover:from-pink-600 hover:to-purple-700 transition-all whitespace-nowrap cursor-pointer"
              >
                Comprar agora
              </a>
            </div>
            <div className="relative">
              <div className="w-full h-96 rounded-3xl overflow-hidden">
                <img 
                  src="https://readdy.ai/api/search-image?query=Modern%20smartphone%20displaying%20Instagram%20app%20interface%20with%20heart%20likes%20increasing%2C%20social%20media%20engagement%20concept%2C%20clean%20minimalist%20design%2C%20bright%20pink%20and%20purple%20gradient%20colors%2C%20professional%20marketing%20photography%2C%20high%20quality%20digital%20illustration&width=600&height=800&seq=instagram-likes-growth&orientation=portrait" 
                  alt="Instagram Likes Growth" 
      ...
      <section className="py-16 bg-gradient-to-br from-pink-50 via-purple-50 to-white lazy-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
          ...
          <div className="text-center">
            <div className="inline-flex items-center gap-8 bg-white rounded-2xl p-6 shadow-lg">
              <img 
                src="https://readdy.ai/api/search-image?query=Instagram%20likes%20and%20engagement%20concept%20illustration%20with%20heart%20icons%2C%20modern%20smartphone%20displaying%20social%20media%20metrics%2C%20professional%20digital%20marketing%20design%2C%20pink%20and%20purple%20gradient%20colors%2C%20clean%20minimalist%20style%2C%20high%20quality%20business%20photography%20showing%20growth%20and%20success&width=400&height=400&seq=instagram-likes-reasons-impulsione&orientation=squarish" 
              ...
              <div className="text-left">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">
                  4 razões para comprar curtidas na Impulsione Social
                </h3>
                <p className="text-gray-600">
                  Como uma equipe em crescimento nas redes e após anos de estudo, aprendemos esses aspectos para comprar curtidas no Instagram
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl p-8">
              ...
              <div className="w-full h-1 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full mb-4"></div>
              <p className="text-gray-600 mb-4">
                Não, quando você faz uma compra com a Impulsione Social sua conta não corre nenhum perigo, e isso é legal. Não violamos nenhuma regra do Instagram ao realizar esse processo, por isso é 100% seguro.
              </p>
              <p className="text-gray-600">
                Milhares de grandes influenciadores do Instagram usam esses métodos. Se houvesse algum problema com isso, eles não ousariam expor suas contas a eles.
              </p>
            </div>
          ...
          <div className="mt-12 text-center">
            <a 
              href="#pacotes" 
              className="inline-flex items-center gap-2 bg-gradient-to-r from-pink-500 to-purple-600 text-white px-8 py-4 rounded-full font-medium text-lg hover:from-pink-600 hover:to-purple-700 transition-all shadow-lg whitespace-nowrap cursor-pointer"
            >
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-pink-500 to-purple-600 lazy-section">
